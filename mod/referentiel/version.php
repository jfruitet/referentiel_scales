...
$module->version  = 2014022804;  // The current module version (Date: YYYYMMDDXX)
$module->release  = 'Referentiel v 10.01 for Moodle 2.4 et 2.5 with scale support and block - Release 2014-11-16';    // User-friendly date of release
