				    ...
				    if ($records){
                        ...
                        foreach ($records as $record) {
                            ...
                            elseif (isset($mode) && ($mode=='listactivityall')){
                                ...
                                referentiel_print_activite_detail($record, $context, true, $num);
                                if (!$record->approved){
                            ...
                            elseif (isset($mode) && ($mode=='listactivitysingle')){
                                referentiel_print_activite_detail($record, $context, false, $num);
                                if (!$record->approved){
                                    echo '<div align="center">'.referentiel_ajout_document($record, $mode, $select_acc)."</div>\n";
                                }
                                if (!$record->approved){
